...
Given this, classes can specify that they require properties files to be loaded. E.g.
...
When Guice injects MyClass, Governator will call MyAssetLoader with "myProperties.txt" prior to calling any methods marked with @PostConstruct.
