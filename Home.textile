...
The <code>com.netflix.governator.annotations.binding</code> contains several generic binding annotations that you might find useful. These might be more clear and more maintainable to users than using Guice's <code>@Named</code>.
