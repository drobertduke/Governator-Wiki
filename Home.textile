...
The <code>com.netflix.governator.annotations.binding</code> package contains a set of generic binding annotations that you might find useful. These might be more clear and more maintainable to users than using Guice's <code>@Named</code>.
